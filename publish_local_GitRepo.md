...
8. Back under your "Repositories" dropdown, select the cloud and arrow icon to **Publish to GitHub**
9. VS Code will create popup:  
    `The extension 'GitHub' wants to sign in using GitHub.`  
    Select "**Allow**"
10. VS Code will launch a new tab in your web browser
...
11. GitHub will now prompt you to authorize VS Code. Review settings and then press "Authorize Visual-Studio-Code" 
12. You will now have to verify access via email, select "Verify via email"
13. Navigate to email, open email from GitHub, copy verification code
14. Paste verification code as prompted by GitHub
15. This verification will launch VS Code again, opening the program with  
...
16. VS Code will upload to GitHub and deliver pop-up: 
```
...
17. Success. You may now edit your repo on GitHub and share with others. 